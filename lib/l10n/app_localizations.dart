...
abstract class AppLocalizations {
  ...
  /// No description provided for @jsonConverterTitle.
  ///
  /// In en, this message translates to:
  /// **'Text type Convert'**
  String get jsonConverterTitle;

  /// No description provided for @fileVerifierTitle.
  ///
  /// In en, this message translates to:
  /// **'File Verifier'**
  String get fileVerifierTitle;

  /// No description provided for @requesterTitle.
  ///
  /// In en, this message translates to:
  /// **'HTTP Requester'**
  String get requesterTitle;

  /// No description provided for @base64EncoderTitle.
  ///
  /// In en, this message translates to:
  /// **'Base64 En/Decoder'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Access the web version of Fluru Tools.'**
  String get webVersionDescription;
